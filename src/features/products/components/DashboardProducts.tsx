...
import { useGetResellerPricing } from "../api/api";
...
export default function DashboardProduct() {
  ...
  const { data } = useGetResellerPricing({
    ...
    is_flash_sale: filters.is_flash_sale,
  });
  ...
  const handleFlashSale = useCallback((status: string) => {
    setFilters((prev) => ({ ...prev, is_flash_sale: status, page: 1 }));
  }, []);
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <Select
                  value={filters.is_flash_sale}
                  onValueChange={handleFlashSale}
                >
                  <SelectTrigger className="w-32">
                    <SelectValue />
                  </SelectTrigger>
