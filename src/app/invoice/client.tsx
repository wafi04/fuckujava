            ...
            <div className="space-y-6">
                  ...
                  )}
                  {
                    invoice.status === "failed" && (
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-right">
                          Silahkan untuk cek whatsapp, Jika Belum Menerima Silahkan bisa hubungi Admin
                        </span>
                      </div>
              ...
              <div>
                <button
                  ...
                  className="inline-flex w-full items-center justify-between rounded-lg border border-border/25 bg-primary/50 px-4 py-3 text-sm font-medium shadow-sm transition-colors"
                  type="button"
                >
                ...
                {showPaymentDetails && (
                  <div className="mt-2 rounded-lg border border-border/25 bg-primary/50 p-4 text-sm">
              ...
              {/* Total */}
              <div className="flex justify-between items-center rounded-lg border-2 border-primary/50 bg-primary/50 p-4">
